                ...
                <div class="row">
                    <div class="col-6">
                        <input type="text" name="name" id="" placeholder="Your Name"
                               class="pt-3 pb-3 mt-5 form-control">
                    </div>
                    <div class="col-6">
                        <input type="text" name="email" id="" placeholder="Your E-Mail"
                               class="pt-3 pb-3 mt-5 form-control">
                    </div>
                    <div class="col-12">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" name="message" mt-3" rows="6" placeholder="Your
                        Message"></textarea>
                    </div>
                    <div class="col-xs-12">
                        <div class="d-flex justify-content-center">
