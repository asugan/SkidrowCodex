        ...
        <div class="row">
            <div class="col-12 text-white">
                ...
                <p class="mt-3">
                    ...
                    the store, and give a physical carrier with trembling hands: «And what if you spoil?». Maybe something
                    nostalgic is in those times, and SkidrowGameReloaded.co not at all against pleasant memories — enjoy
                    them while the game is swinging. Only strongly ponostalgirovat will not work — with our service games
                ...
                <p class="mt-3">SkidrowandCodex.com — this is a 100% up-to-date solution for demanding gamers.
                    ...
                    in connection with any game mechanics, graphics, plot. We treat games as works of art, we believe that
                ...
                <p> 1- the user does not need to register to gain access to the files,<br>
                    ...
                    3- there are no ad units — these pieces are not just annoying, but also slow down the process of surfing
                    the site.<br>
                </p>
            </div>
        </div>
